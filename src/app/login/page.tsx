...
import { QrCode, Mail, Lock, Loader2, Github, AlertTriangle } from 'lucide-react';

export default function LoginPage() {
  const router = useRouter();
  const { login, isAuthenticated, isLoading, error, initialize } = useAuthStore();
    ...
    <div className="min-h-screen bg-[#030307] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-500">Sign in to start creating AI QR art</p>
        </div>
